...
def run_optimization(flowsheet_name, list_unit, list_inlet, list_outlet, visualize_flowsheet = False):
    ...
    try:
        ...
        return score, IDAES_status, IDAES_costing
    ...
    if status == 'optimal':
        score = 1000 + (flow-0.10)/0.05*delta_scoreA + (purity-0.55)/0.10*delta_scoreB
...
#------------------------------------------------------------------------------
    ...
    visualize_flowsheet = False
    status, IDAES_status, IDAES_costing = run_optimization(flowsheet_name, list_unit, list_inlet, list_outlet, visualize_flowsheet)

#%%
    ########## Appendix ##########
    # # option 1: with optimal solution: purity = 0.76, benzene = 0.20
    # list_unit = ['inlet_feed', 'mixer2to1_1', 'heater_1','StReactor_1', 'flash_1', 'splitter1to2_1', 'compressor_1', 'outlet_product', 'outlet_exhaust']
    # list_inlet = ['mixer2to1_1.inlet_1', 'mixer2to1_1.inlet_2', 'heater_1.inlet', 'StReactor_1.inlet', 'flash_1.inlet', 'outlet_product.inlet', 'splitter1to2_1.inlet', 'compressor_1.inlet', 'outlet_exhaust.inlet']
    # list_outlet = ['inlet_feed.outlet', 'compressor_1.outlet', 'mixer2to1_1.outlet', 'heater_1.outlet', 'StReactor_1.outlet','flash_1.liq_outlet', 'flash_1.vap_outlet', 'splitter1to2_1.outlet_1', 'splitter1to2_1.outlet_2']
    
    # # option 2: with optimal solution: purity = 0.73, benzene = 0.19
    # list_unit = ['inlet_feed', 'outlet_product', 'outlet_exhaust', 'heater_1', 'StReactor_1', 'flash_1']
    # list_inlet = ['heater_1.inlet', 'StReactor_1.inlet', 'flash_1.inlet', 'outlet_product.inlet', 'outlet_exhaust.inlet']
    # list_outlet = ['inlet_feed.outlet', 'heater_1.outlet', 'StReactor_1.outlet', 'flash_1.liq_outlet', 'flash_1.vap_outlet']

    # # option 3: with optimal solution: purity = 0.75, benzene = 0.22
    # list_unit = ['inlet_feed', 'heater_1', 'StReactor_1', 'outlet_product']
    # list_inlet = ['heater_1.inlet', 'StReactor_1.inlet', 'outlet_product.inlet']
    # list_outlet = ['inlet_feed.outlet', 'heater_1.outlet', 'StReactor_1.outlet']

    # # option 4: purity = 0.31, benzene = 0.00 -> infeasible
    # list_unit = ['inlet_feed', 'StReactor_1', 'outlet_product', 'flash_1', 'outlet_exhaust']
    # list_inlet = ['StReactor_1.inlet', 'flash_1.inlet', 'outlet_exhaust.inlet', 'outlet_product.inlet']
    # list_outlet = ['inlet_feed.outlet', 'StReactor_1.outlet', 'flash_1.vap_outlet', 'flash_1.liq_outlet']

    # # option 5: purity = 0.50, benzene = 0.00 -> infeasible
    # list_unit = ['inlet_feed', 'StReactor_1', 'outlet_product']
    # list_inlet = ['StReactor_1.inlet', 'outlet_product.inlet']
    # list_outlet = ['inlet_feed.outlet', 'StReactor_1.outlet']

#%%
    ########## Appendix ##########
    # # option 1: optimal
    # list_unit = ['inlet_feed', 'mixer2to1_1', 'heater_1','StReactor_1', 
    #             'flash_1', 'splitter1to2_1', 'compressor_1', 'outlet_product', 'outlet_exhaust']
    # list_inlet = ['StReactor_1.inlet', 'mixer2to1_1.inlet_2', 'mixer2to1_1.inlet_1', 'heater_1.inlet', 
    #             'outlet_product.inlet', 'splitter1to2_1.inlet', 'compressor_1.inlet', 'flash_1.inlet', 
    #             'outlet_exhaust.inlet']
    # list_outlet = ['heater_1.outlet', 'compressor_1.outlet', 'inlet_feed.outlet', 'mixer2to1_1.outlet', 
    #             'flash_1.liq_outlet', 'flash_1.vap_outlet', 'splitter1to2_1.outlet_1', 'StReactor_1.outlet',
    #             'splitter1to2_1.outlet_2']

    # # option 1: infeasible
    # list_unit = ['inlet_feed', 'mixer2to1_1', 'heater_1','StReactor_1', 
    #             'flash_1', 'splitter1to2_1', 'compressor_1', 'outlet_product', 'outlet_exhaust']
    # list_inlet = ['flash_1.inlet', 'outlet_product.inlet', 'splitter1to2_1.inlet', 'compressor_1.inlet', 
    #                 'heater_1.inlet', 'StReactor_1.inlet', 'mixer2to1_1.inlet_2', 'mixer2to1_1.inlet_1', 
    #             'outlet_exhaust.inlet']
    # list_outlet = ['StReactor_1.outlet','flash_1.liq_outlet', 'flash_1.vap_outlet', 'splitter1to2_1.outlet_1', 
    #             'mixer2to1_1.outlet', 'heater_1.outlet', 'compressor_1.outlet', 'inlet_feed.outlet', 
    #             'splitter1to2_1.outlet_2']

    # # option 1: optimal
    # list_unit = ['inlet_feed', 'mixer2to1_1', 'heater_1','StReactor_1', 
    #             'flash_1', 'splitter1to2_1', 'compressor_1', 'outlet_product', 'outlet_exhaust']
    # list_inlet = ['outlet_exhaust.inlet',
    #             'heater_1.inlet', 'StReactor_1.inlet', 'mixer2to1_1.inlet_2', 'mixer2to1_1.inlet_1', 
    #             'flash_1.inlet', 'outlet_product.inlet', 'splitter1to2_1.inlet', 'compressor_1.inlet']
    # list_outlet = ['splitter1to2_1.outlet_2',
    #             'mixer2to1_1.outlet', 'heater_1.outlet', 'compressor_1.outlet', 'inlet_feed.outlet', 
    #             'StReactor_1.outlet','flash_1.liq_outlet', 'flash_1.vap_outlet', 'splitter1to2_1.outlet_1']

    # # option 2: optimal
    # list_unit = ['outlet_product', 'outlet_exhaust', 'heater_1', 'StReactor_1', 'flash_1', 'inlet_feed']
    # list_inlet = ['flash_1.inlet', 'outlet_product.inlet', 'StReactor_1.inlet', 'heater_1.inlet', 'outlet_exhaust.inlet']
    # list_outlet = ['StReactor_1.outlet', 'flash_1.liq_outlet', 'heater_1.outlet', 'inlet_feed.outlet', 'flash_1.vap_outlet']

    # # option 2: optimal
    # list_unit = ['outlet_product', 'outlet_exhaust', 'heater_1', 'StReactor_1', 'flash_1', 'inlet_feed']
    # list_inlet = ['StReactor_1.inlet', 'heater_1.inlet', 'outlet_exhaust.inlet', 'flash_1.inlet', 'outlet_product.inlet']
    # list_outlet = ['heater_1.outlet', 'inlet_feed.outlet', 'flash_1.vap_outlet', 'StReactor_1.outlet', 'flash_1.liq_outlet']

    # # option 2: optimal
    # list_unit = ['outlet_product', 'outlet_exhaust', 'heater_1', 'StReactor_1', 'flash_1', 'inlet_feed']
    # list_inlet = ['StReactor_1.inlet',  'outlet_exhaust.inlet', 'flash_1.inlet', 'heater_1.inlet', 'outlet_product.inlet']
    # list_outlet = ['heater_1.outlet', 'flash_1.vap_outlet', 'StReactor_1.outlet', 'inlet_feed.outlet', 'flash_1.liq_outlet']